...
function FormExample() {
	...
	return (
		<div class="mx-auto p-2  mt-5 bg-black bg-opacity-70 rounded-md flex flex-col lg:flex-row gap-2 max-w-[800px] ">
			<Form className="w-1/2" onSubmit={onUserStore} {...usersStoreForm}>
				<Form.control.web
			...
			<div class="w-full lg:w-1/2 ">
				<h3 class="text-center font-bold text-white ">
					Usuarios{" "}
					{users.value.length ? (
						<b class="text-xs text-white font-bold">{users.value.length}</b>
					) : null}
				</h3>
				<div>
					{users.value.length ? (
